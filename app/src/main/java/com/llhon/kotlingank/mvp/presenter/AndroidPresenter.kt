 ...
 * @description
 */
class AndroidPresenter(context: Context) : BasePresenter<AndroidContract.View>(), AndroidContract.Presenter {
...
//            }
//        }
        apiService?.getAndroidData(curPage)?.applySchedulers()?.subscribe(object : Observer<HttpResult<MutableList<GankBean>>> {
